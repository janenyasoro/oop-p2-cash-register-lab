...
class TestCashRegister:
    ...
    def setup_method(self):
        '''Reset the register before each test'''
        self.cash_register = CashRegister()
        self.cash_register_with_discount = CashRegister(20)

    def reset_register_totals(self, register=None):
        '''Reset a specific register or both registers'''
        if register is None:
            ...
            register.total = 0
            register.items = []
            register.previous_transactions = []
    ...
    def test_add_item(self):
        ...
        self.reset_register_totals(self.cash_register)
    ...
    def test_apply_discount(self):
        ...
        self.reset_register_totals(self.cash_register_with_discount)
